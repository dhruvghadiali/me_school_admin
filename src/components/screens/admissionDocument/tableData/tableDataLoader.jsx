...
const AdmissionDocumentScreenTableDataLoader = () => {
  return (
    <div className="border-2 border-secondary mt-10">
      {_.times(15, (index) => {
        return (
          <>
            <div key={_.uniqueId()} className={`grid grid-flow-row grid-cols-8`}>
...
AdmissionDocumentScreenTableDataLoader.propTypes = {};

export default AdmissionDocumentScreenTableDataLoader;
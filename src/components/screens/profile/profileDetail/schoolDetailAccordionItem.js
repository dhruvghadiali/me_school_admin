...
const ProfileScreenSchoolDetailAccordionItem = ({ item }) => {
...
ProfileScreenSchoolDetailAccordionItem.prototype = {
  item: PropTypes.any,
};

export default ProfileScreenSchoolDetailAccordionItem;

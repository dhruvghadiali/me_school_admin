...
import { TrendingUp, FileCheck, CheckCircle2, XCircle, Clock } from "lucide-react";
import { Bar, BarChart, CartesianGrid, XAxis, Line, LineChart, YAxis, PieChart, Pie, Cell, Legend, Tooltip } from "recharts";
...
const applicationStatusPieData = [
  { name: "Approved", value: 89, color: "hsl(142 71% 45%)" },
  { name: "Pending", value: 49, color: "hsl(221 83% 53%)" },
  { name: "Rejected", value: 18, color: "hsl(0 84% 60%)" },
];
...
const DashboardPage = () => {
  ...
  return (
    <>
      ...
      {/* Charts Grid */}
      <div className="mt-8 mb-16 grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-slate-50 dark:bg-slate-900">
                    <TableHead className="text-slate-900 dark:text-white font-semibold">Academic Year</TableHead>
                    <TableHead className="text-slate-900 dark:text-white font-semibold">Total Applications</TableHead>
                    <TableHead className="text-slate-900 dark:text-white font-semibold">Approved</TableHead>
                    <TableHead className="text-slate-900 dark:text-white font-semibold">Rejected</TableHead>
                    <TableHead className="text-slate-900 dark:text-white font-semibold">Pending</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
